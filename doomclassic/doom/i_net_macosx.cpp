...
void PacketSend (void)
{
	...
	// Send Socket
	{
		...
		//} else {
			c = DoomLib::Send( (char*)&sw, ::g->doomcom.datalength, (struct sockaddr_in*)&::g->sendaddress[::g->doomcom.remotenode], ::g->doomcom.remotenode );
		//}
	}
}
...
#endif // ID_ENABLE_DOOM_CLASSIC_NETWORKING
}
