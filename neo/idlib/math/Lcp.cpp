...
ALIGN16( const unsigned int SIMD_SP_absMask[4] )				= { ~(unsigned int)IEEE_FLT_SIGN_MASK, ~(unsigned int)IEEE_FLT_SIGN_MASK, ~(unsigned int)IEEE_FLT_SIGN_MASK, ~(unsigned int)IEEE_FLT_SIGN_MASK };
