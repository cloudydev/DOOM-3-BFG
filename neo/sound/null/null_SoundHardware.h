...
===========================================================================
*/
#ifndef __NULL_SOUNDHARDWARE_H__
#define __NULL_SOUNDHARDWARE_H__

class idSoundSample_NULL;
class idSoundVoice_NULL;
...
/*
================================================
idSoundHardware_NULL
================================================
*/

class idSoundHardware_NULL {
public:
					idSoundHardware_NULL();
...
protected:
	friend class idSoundSample_NULL;
	friend class idSoundVoice_NULL;
...
//	IXAudio2SubmixVoice * pSubmixVoice;
	...
	idStaticList<idSoundVoice_NULL, MAX_HARDWARE_VOICES * 2 > voices;
	idStaticList<idSoundVoice_NULL *, MAX_HARDWARE_VOICES * 2 > zombieVoices;
	idStaticList<idSoundVoice_NULL *, MAX_HARDWARE_VOICES * 2 > freeVoices;
};
...
================================================
*/
class idSoundHardware : public idSoundHardware_NULL {
};
