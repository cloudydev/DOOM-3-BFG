...
/*
========================
idSoundSample_NULL::idSoundSample_NULL
========================
*/
idSoundSample_NULL::idSoundSample_NULL() {
...
/*
========================
idSoundSample_NULL::WriteGeneratedSample
========================
*/
void idSoundSample_NULL::WriteGeneratedSample( idFile *fileOut ) {
...
/*
========================
idSoundSample_NULL::WriteAllSamples
========================
*/
void idSoundSample_NULL::WriteAllSamples( const idStr &sampleName ) {
	idSoundSample_NULL * samplePC = new idSoundSample_NULL();
	{
...
/*
========================
idSoundSample_NULL::LoadGeneratedSound
========================
*/
bool idSoundSample_NULL::LoadGeneratedSample( const idStr &filename ) {
...
/*
========================
idSoundSample_NULL::Load
========================
*/
void idSoundSample_NULL::LoadResource() {
	FreeData();
...
/*
========================
idSoundSample_NULL::LoadWav
========================
*/
bool idSoundSample_NULL::LoadWav( const idStr & filename ) {
...
/*
========================
idSoundSample_NULL::MakeDefault
========================
*/
void idSoundSample_NULL::MakeDefault() {
	FreeData();
	...
	format.basic.samplesPerSec = 8000;
...
/*
========================
idSoundSample_NULL::LoadAmplitude
========================
*/
bool idSoundSample_NULL::LoadAmplitude( const idStr & name ) {
	amplitude.Clear();
...
/*
========================
idSoundSample_NULL::GetAmplitude
========================
*/
float idSoundSample_NULL::GetAmplitude( int timeMS ) const {
