...
===========================================================================
*/
#ifndef __NULL_SOUNDVOICE_H__
#define __NULL_SOUNDVOICE_H__
...
================================================
*/
class idSoundVoice_NULL : public idSoundVoice_Base {
public:
							idSoundVoice_NULL();
							~idSoundVoice_NULL();
	...
	bool					CompatibleFormat( idSoundSample_NULL * s );

	uint32					GetSampleRate() const { return sampleRate; }

	// callback function
	void					OnBufferStart( idSoundSample_NULL * sample, int bufferNumber );

private:
	friend class idSoundHardware_NULL;
	...
	int						SubmitBuffer( idSoundSample_NULL * sample, int bufferNumber, int offset );
...
//	IXAudio2SourceVoice *	pSourceVoice;
	idSoundSample_NULL *	leadinSample;
	idSoundSample_NULL *	loopingSample;
...
================================================
*/
class idSoundVoice : public idSoundVoice_NULL {
};
