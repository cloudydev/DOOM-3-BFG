...
/*
========================
idSignInManagerNULL::Shutdown
========================
*/
void idSignInManagerNULL::Shutdown() {
}

/*
========================
idSignInManagerNULL::Pump
========================
*/
void idSignInManagerNULL::Pump() {
...
/*
========================
idSignInManagerNULL::RemoveLocalUserByIndex
========================
*/
void idSignInManagerNULL::RemoveLocalUserByIndex( int index ) {
...
/*
========================
idSignInManagerNULL::RegisterLocalUser
========================
*/
void idSignInManagerNULL::RegisterLocalUser( int inputDevice ) {
	...
	if( idStr::IsValidUTF8( nameSource, nameLength ) ) {
		...
		int numChars = 0;
		name.Empty();
		while( nameIndex < nameLength && numChars++ < idLocalUserNULL::MAX_GAMERTAG_CHARS ) {
	...
	idLocalUserNULL & localUser = *localUsers.Alloc();
...
/*
========================
idSignInManagerNULL::CreateNewUser
========================
*/
bool idSignInManagerNULL::CreateNewUser( nullUserState_t & state ) {
